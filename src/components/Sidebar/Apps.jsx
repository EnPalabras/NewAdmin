...
export default function Apps({ isDropdownOpen, setIsDropdownOpen }) {
  return (
    <>
      <button
        type="button"
        ...
        className="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white  border-none focus:border-none focus:outline-none"
      >
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-4 p-4">
          ...
          >
            ...
            <div className="text-sm text-gray-900 dark:text-white">Ventas</div>
          </a>
          <a
            href="#"
            className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
          >
            ...
            <div className="text-sm text-gray-900 dark:text-white">Equipo</div>
          </a>
          ...
          >
            ...
            <div className="text-sm text-gray-900 dark:text-white">Mayor.</div>
          </a>
          <a
            href="#"
            className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
          ...
          >
            ...
            <div className="text-sm text-gray-900 dark:text-white">Config.</div>
          </a>
          <a
            href="#"
            className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group"
