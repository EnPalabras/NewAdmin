'use client'
import FooterBar from '../Aside/FooterBar'
import Link from 'next/link'
import { useState } from 'react'

export default function Aside({ showSidebar }) {
          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              <ul
                ...
                className={`${isOpen.dash ? '' : 'hidden'} py-2 space-y-2`}
              >
                <li>
                  <a
                    href="#"
            ...
            <li>
              ...
              <ul
                id="dropdown-sales"
                className={`${isOpen.sales ? '' : 'hidden'} py-2 space-y-2`}
              >
                <li>
                  <a
                    href="#"
            ...
            <li>
              ...
              <ul
                id="dropdown-upload"
                className={`${isOpen.upload ? '' : 'hidden'} py-2 space-y-2`}
              >
                <li>
                  <Link
                    href="/cargar/reventa"
          ...
          <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3">Mayoristas</span>
              </Link>
            </li>
            {/* <li>
            <a
